...
class Squib::ActiveRecord_Relation < ActiveRecord::Relation
  include Squib::ModelRelationShared
  extend T::Generic
...
class Squib < Wizard
  extend T::Sig
  extend T::Generic
  extend Squib::ModelRelationShared
  include Squib::InstanceMethods
  Elem = type_template(fixed: Squib)
end

module Squib::InstanceMethods
  extend T::Sig
...
module Squib::ModelRelationShared
  extend T::Sig
